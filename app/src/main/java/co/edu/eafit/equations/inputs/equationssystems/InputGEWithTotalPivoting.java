...
public class InputGEWithTotalPivoting extends Fragment {
    TableLayout matrixinput;
    TableLayout vectorbinput;
    int size;
    public static InputGEWithTotalPivoting newInstance() {
        InputGEWithTotalPivoting fragment = new InputGEWithTotalPivoting();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_input_ge_with_total_pivoting, container, false);
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TableGEWithTotalPivoting tabgauelm = (TableGEWithTotalPivoting)activity.getFragmentTable();
                //tabgauelm.getText().setText(matrix.toString()+"\n"+vectorb.toString());
                double elementoMayor = Math.abs(matrix.get(size - 1, size - 1));
                if(elementoMayor != 0) {
                    String aux = Methods.eliminacionGaussianaConPivoteoTotal(matrix, vectorb, size);
