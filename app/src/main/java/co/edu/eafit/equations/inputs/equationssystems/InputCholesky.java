...
public class InputCholesky extends Fragment {
    ...
    int size;
    public static InputCholesky newInstance() {
        InputCholesky fragment = new InputCholesky();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_input_cholesky, container, false);
