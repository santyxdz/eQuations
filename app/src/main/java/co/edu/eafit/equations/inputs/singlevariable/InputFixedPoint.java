...
public class InputFixedPoint extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText inpt_gx = (EditText)rootView.findViewById(R.id.inpt_gx);
        ...
        btn_run.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Methods.FixedPoint(x0, tol, iter, tipeError[0], inpt_fx.getText().toString(),
                        inpt_gx.getText().toString(),((Tabs) getActivity()).getTabla()
