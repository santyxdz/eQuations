...
public class InputIncrementalSearches extends Fragment {
    ...
    public static InputIncrementalSearches newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_input_incremental_searches, container, false);
