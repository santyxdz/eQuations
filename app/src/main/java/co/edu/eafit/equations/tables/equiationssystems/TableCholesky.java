...
public class TableCholesky extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public TextView text;
    public static TableCholesky newInstance() {
        TableCholesky fragment = new TableCholesky();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public TableCholesky() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_table_cholesky, container, false);
