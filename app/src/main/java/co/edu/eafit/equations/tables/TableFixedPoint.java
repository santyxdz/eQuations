...
public class TableFixedPoint extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public static TableFixedPoint newInstance(int sectionNumber) {
        TableFixedPoint fragment = new TableFixedPoint();
    ...
    public TableFixedPoint() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_table_fixed_point, container, false);
