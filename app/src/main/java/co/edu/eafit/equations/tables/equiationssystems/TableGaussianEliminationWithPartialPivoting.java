...
public class TableGaussianEliminationWithPartialPivoting extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public TextView text;
    public static TableGaussianEliminationWithPartialPivoting newInstance() {
        TableGaussianEliminationWithPartialPivoting fragment = new TableGaussianEliminationWithPartialPivoting();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public TableGaussianEliminationWithPartialPivoting() {
    }
    @Override
