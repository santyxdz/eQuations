...
public class InputCubicSpline extends Fragment {
    TableLayout matrixinput;
    TableLayout vectorbinput;
    int size;
    int numPoints;
    public static InputCubicSpline newInstance() {
        InputCubicSpline fragment = new InputCubicSpline();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TableCubicSpline table = (TableCubicSpline)activity.getFragmentTable();
                String res = Methods.interpolacionCubicSpline(numPoints, value, vectorx, vectory);
