...
public class TableFalsePosition extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public static TableFalsePosition newInstance(int sectionNumber) {
        TableFalsePosition fragment = new TableFalsePosition();
    ...
    public TableFalsePosition() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_table_false_position, container, false);
