...
public class TableGaussSeidel extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public TextView text;
    public static TableGaussSeidel newInstance() {
        TableGaussSeidel fragment = new TableGaussSeidel();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public TableGaussSeidel() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_table_gauss_seidel, container, false);
