...
public class TableGEWithTotalPivoting extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public TextView text;
    public static TableGEWithTotalPivoting newInstance() {
        TableGEWithTotalPivoting fragment = new TableGEWithTotalPivoting();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public TableGEWithTotalPivoting() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_table_ge_with_total_pivoting, container, false);
