...
public class TableNewton extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public static TableNewton newInstance(int sectionNumber) {
        TableNewton fragment = new TableNewton();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_table_newton, container, false);
