package co.edu.eafit.equations.methods.classes;
...
public class CubicSpline{
    ...
    /*public static void main(String args[]){
        double[] xnvalues = {0.1,0.2,0.5,1,2,5,10};
        double[] ynvalues = {10,5,2,1,0.5,0.2,0.1};
        ArrayList<Double> xn = new ArrayList<>();
        ArrayList<Double> yn = new ArrayList<>();
        for(double x:xnvalues){
            xn.add(x);
        }
        for(double y:ynvalues){
            yn.add(y);
        }
        CubicSpline cs = new  CubicSpline(xn,yn);
        System.out.println(cs);
        System.out.println(cs.evaluate(2.0));
    }*/
