...
public class InputMultipleRoots extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText inpt_function_ddfx = (EditText)rootView.findViewById(R.id.inpt_function_ddfx);
        ...
        btn_run.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Methods.MultipleRoots(x0, tol, iter, tipeError[0], inpt_function.getText().toString(),
                        inpt_function_dfx.getText().toString(), inpt_function_ddfx.getText().toString(),
