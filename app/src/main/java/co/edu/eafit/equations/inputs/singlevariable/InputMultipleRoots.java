...
public class InputMultipleRoots extends Fragment {
    ...
    public static InputMultipleRoots newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_input_mutiple_roots, null);
        ...
        final EditText inpt_fppx = (EditText)rootView.findViewById(R.id.inpt_fppx);
            ...
            public void onClick(View v) {
                ...
                ((Tabs) getActivity()).getTabla().addHead(
                        getActivity().getResources().getStringArray(
                                R.array.cabecera_tabla_multiple_roots
                        )
                );
                Methods.MultipleRoots(x0, tol, iter, tipeError[0], inpt_fx.getText().toString(),
                        inpt_fpx.getText().toString(), inpt_fppx.getText().toString(),
                ((Tabs) getActivity()).getTabla()

                );
                ((TableMultipleRoots) ((Tabs) getActivity()).getFragmentTable()).load_tables();
                ...
                editor.putString("fppx",inpt_fppx.getText().toString());
