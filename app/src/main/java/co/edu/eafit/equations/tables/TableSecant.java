...
public class TableSecant extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private int sectionNumber;
    private TableLayout tableLayout;
    public static TableSecant newInstance(int sectionNumber) {
        TableSecant fragment = new TableSecant();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_table_secant, container, false);
