...
public class MenuAdapterVA extends ArrayAdapter<String>{
    ...
    public MenuAdapterVA(final Context context, final int textViewResourceId){
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        vh.txtLineOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (position){
                    case 0:
                        intent.putExtra("type","Partial Pivoting");
                        break;
                    case 1:
