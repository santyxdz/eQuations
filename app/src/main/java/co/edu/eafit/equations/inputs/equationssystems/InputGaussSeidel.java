...
public class InputGaussSeidel extends Fragment {
    TableLayout matrixinput;
    TableLayout vectorbinput;
    TableLayout vectorinit;
    int size;
    public static InputGaussSeidel newInstance() {
        InputGaussSeidel fragment = new InputGaussSeidel();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_input_gauss_seidel, container, false);
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Methods.gaussSeidel(matrix, vectorb, vectorx, iter, tol, lambda, size, ((Tabs) getActivity()).getTabla());
                ((TableGaussSeidel)((Tabs) getActivity()).getFragmentTable()).load_tables();
